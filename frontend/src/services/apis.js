...
export const authEndpoints = {
    SEND_OTP_API : "/api/v1/users/sendOTP",
...
export const profileEndpoints = {
  GET_USER_DETAILS_API: "/api/v1/profile/get-user-details",
  GET_USER_ENROLLED_COURSES_API: "/api/v1/profile/get-enrolled-courses",
}

// STUDENTS ENDPOINTS
export const studentEndpoints = {
  COURSE_PAYMENT_API: "/api/v1/payment/capture-payment",
  COURSE_VERIFY_API: "/payment/verify-signature",
//   SEND_PAYMENT_SUCCESS_EMAIL_API: BASE_URL + "/payment/sendPaymentSuccessEmail",
}

// COURSE ENDPOINTS
export const courseEndpoints = {
  GET_ALL_COURSE_API: "/api/v1/courses/get-all-courses",
  COURSE_DETAILS_API: "/api/v1/courses/get-course",
  EDIT_COURSE_API:  "/course/editCourse",
  COURSE_CATEGORIES_API: "/api/v1/courses/show-all-categories",
